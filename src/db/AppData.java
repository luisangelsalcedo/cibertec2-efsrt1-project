...
public class AppData {
	...
	static {
		...
		menu4.addProduct(new Burger(royal, SizeProduct.BIG));
		menu4.addProduct(new Potatoes(potatoes, SizeProduct.BIG));
		menu4.addProduct(new Soda(cocacola));
		
		// product 5
		BembosMenu menu5 = new BembosMenu("Duo A lo Pobre");
		menu5.addProduct(new Burger(alopobre, SizeProduct.MEDIUM));
		menu5.addProduct(new Burger(alopobre, SizeProduct.MEDIUM));
		menu5.addProduct(new Potatoes(potatoes, SizeProduct.MEDIUM));
		menu5.addProduct(new Potatoes(potatoes, SizeProduct.MEDIUM));
